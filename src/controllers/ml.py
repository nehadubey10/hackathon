...
def userlogin():
    ...
    try:
        ...
        print("dfghj")
        df1= {"qty":[qty],"total_price":[total_price],"freight_price":[freight_price],"product_name_lenght":[product_name_lenght],"product_description_lenght":[product_description_lenght],"product_photos_qty":[product_photos_qty],
